<template>
  ...
  <form id="accesspanel">
    <h1 id="litheader">Авторизация</h1>
    <div class="inset">
      <p>
        <input type="text" name="username" id="email" v-model="login" placeholder="Логин">
      </p>
      <p>
    ...
    <p class="p-container">
      <input type="submit" name="Login" value="Войти" @click.stop.prevent="handleClickSubmitForm">
    </p>
  </form>
  </template>
